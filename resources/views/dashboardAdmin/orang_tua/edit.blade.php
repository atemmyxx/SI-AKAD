...
@section('content')
    <h3 class=" p-2 text-secondary"> Edit Data Orang Tua</h3>
    <div class="row">
        <div class="col-lg-8">
            <div class="m-3">
                <form action="{{ route('orang_tua.update', $orangtua->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="username_ortu" placeholder="isi username orang tua" name="username_ortu"
                            value="{{ old('username_ortu', $orangtua->username_ortu) }}" required>
                        @error('username_ortu')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password"
                            ...
                            value="{{ old('password', $orangtua->password) }}" required>
                        @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number"
                            ...
                            id="nik_ayah" placeholder="name@example.com" name="nik_ayah"
                            value="{{ old('nik_ayah', $orangtua->nik_ayah) }}" required>
                        @error('nik_ayah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date"
                            ...
                            value="{{ old('tgllahir_ayah', $orangtua->tgllahir_ayah) }}" required>
                        @error('tgllahir_ayah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select @error('pendidikan_ayah') is-invalid @enderror"
                            ...
                            value="{{ old('pendidikan_ayah', $orangtua->pendidikan_ayah) }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select @error('pekerjaan_ayah') is-invalid @enderror"
                            aria-label="Default select example" name="pekerjaan_ayah"
                            value="{{ old('pekerjaan_ayah', $orangtua->pekerjaan_ayah) }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number"
                            ...
                            id="nik_ibu" placeholder="name@example.com" name="nik_ibu"
                            value="{{ old('nik_ibu', $orangtua->nik_ibu) }}" required>
                        @error('nik_ibu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date"
                            ...
                            value="{{ old('tgllahir_ibu', $orangtua->tgllahir_ibu) }}" required>
                        @error('tgllahir_ibu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select @error('pendidikan_ibu') is-invalid @enderror"
                            ...
                            value="{{ old('pendidikan_ibu', $orangtua->pendidikan_ibu) }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select @error('pekerjaan_ibu') is-invalid @enderror"
                            aria-label="Default select example" name="pekerjaan_ibu"
                            value="{{ old('pekerjaan_ibu', $orangtua->pekerjaan_ibu) }}" required>
                            @error('pekerjaan_ibu')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
