...
@section('content')
    <h3 class=" p-2 text-secondary"> Edit Pengumuman</h3>
    <div class="row">
        <div class="col-lg-8">
            <div class="m-3">
                <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date"
                            ...
                            id="tanggal" placeholder="name@example.com" name="tanggal"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            placeholder="name@example.com" name="judul" value="{{ old('judul', $pengumuman->judul) }}"
                            required>
                        @error('judul')
                            <div class="invalid-feedback">
                                {{ $message }}
