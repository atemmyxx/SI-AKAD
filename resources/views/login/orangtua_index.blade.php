        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 shadow p-4">
                    ...
                    @endif --}}
                    {{-- *********************************************** --}}
                    <h2><span style="color: lightslategray">Login Orangtua Wali Siswa</span> </h2>
                    ...
                    @endif
                    <form method="POST" action="{{ route('orangtua_login') }}" class="" novalidate="">
                    {{ csrf_field() }}
                        ...
                        <div class="form-outline mb-4">
                            <input type="username" id="username" name="username"
                                ...
                                <small style="font-size: 12px;color:#8b8b8b;">Username didapat dari Kode Orangtua pada halaman profil siswa.</small>
